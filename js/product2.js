...
let idx = get_cate_url_info('productNo')

if(idx == 0) {
    document.title = `${PRODUCT2[0].bc} | Koeniqsegg Gear`
    breadcrumb_product.innerHTML += `${PRODUCT2[0].bc}`
    page_title.innerHTML += `${PRODUCT2[0].title}`
    page_desc.innerHTML += `
        <span>
            ${PRODUCT2[0].desc}
        </span>`
    ...
    document.title = `${PRODUCT2[1].bc} | Koeniqsegg Gear`
    breadcrumb_product.innerHTML += `${PRODUCT2[1].bc}`
    page_title.innerHTML += `${PRODUCT2[1].title}`
    page_desc.innerHTML += `
        <p>
            ${PRODUCT2[1].desc}
        </p>`
    ...
    document.title = `${PRODUCT2[2].bc} - Car Detailing PRODUCTs | Koenigsegg Gear`
    breadcrumb_product.innerHTML += `${PRODUCT2[2].bc}`
    page_title.innerHTML += `${PRODUCT2[2].title}`
    page_desc.innerHTML += `
        <p>
            ${PRODUCT2[2].desc}
        </p>`
...
for(let i=0; i<ALL_ITEMS.length; i++) {
    for(let j=0; j<ALL_ITEMS[i].length; j++) {
        ...
        // wearables
        if(idx == 0 && ALL_ITEMS[i][j].productNo == 0) {
            item_list.innerHTML += `
                <div class="item_box">
        ...
        // gift
        else if(idx == 1 && ALL_ITEMS[i][j].productNo == 1) {
            item_list.innerHTML += `
                <div class="item_box">
                    <a href="item.html?productNo=${ALL_ITEMS[i][j].productNo}&item_no=${ALL_ITEMS[i][j].item_no}">
                        <div class="item_box_outer">
        ...
        // ghost gleam
        else if(idx == 2 && ALL_ITEMS[i][j].productNo == 2) {
            item_list.innerHTML += `
                <div class="item_box">
                    <a href="item.html?productNo=${ALL_ITEMS[i][j].productNo}&item_no=${ALL_ITEMS[i][j].item_no}">
                        <div class="item_box_outer">
